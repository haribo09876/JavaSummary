...
public class MemberDao {
	...
	public List<MemberDto> memberSelectList() throws Exception {
		...
		try {
			...
			while (rs.next()) {
				...
				MemberDto memberDto = new MemberDto(no, name, email, creDate, modDate);
	...
	// 수집 동의일(mod_date) 변경
	public int memberBatch(int no) throws Exception {
		int result = 0;
